...
import { PAGE_MARGIN_MIN, PAGE_MARGIN_MAX, PAGE_GAP_MIN, PAGE_GAP_MAX, PAGE_GAP_DEFAULT, DEFAULT_SLOT_CORNER_RADIUS, SIZE_PRESETS, PAGE_MARGIN_PRESETS, CUSTOM_SIZE_MIN, CUSTOM_SIZE_MAX } from '../../types';
...
export function PageSettings({ open, onClose }: Props) {
  ...
  useEffect(() => {
    ...
    setGap(s.slotGap);
    setCornerRadius(s.pages[s.currentPageIndex]?.slotCornerRadius ?? DEFAULT_SLOT_CORNER_RADIUS);
